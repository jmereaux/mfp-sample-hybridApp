...
public class SampleJavaAdapterResource {
	...
	/* Path for method: "<server address>/HelloWorldProject/adapters/SampleJavaAdapter/users" */
	@GET
	...
	/* Path for method: "<server address>/HelloWorldProject/adapters/SampleJavaAdapter/users/{username}" */
	@GET
	@Path("/{username}")
	...
	/* Path for method: "<server address>/HelloWorldProject/adapters/SampleJavaAdapter/users/helloUserQuery?name=value" */
	@GET
	@Path("/helloUserQuery")
	...
	/* Path for method: "<server address>/HelloWorldProject/adapters/SampleJavaAdapter/users/prop" */
	@GET
	@Path("/prop")
	...
	/* Path for method: "<server address>/HelloWorldProject/adapters/SampleJavaAdapter/users/{first}/{middle}/{last}?age=value" */
	@POST
	...
	/* Path for method: "<server address>/HelloWorldProject/adapters/SampleJavaAdapter/users/newUsers" */
	@PUT
	@Path("/newUsers")
	...
	/* Path for method: "<server address>/HelloWorldProject/adapters/SampleJavaAdapter/users/helloUserBody" */
	@POST
